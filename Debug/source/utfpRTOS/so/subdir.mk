...
CPP_SRCS += \
../source/utfpRTOS/so/IO.cpp \
../source/utfpRTOS/so/Memory.cpp 

OBJS += \
./source/utfpRTOS/so/IO.o \
./source/utfpRTOS/so/Memory.o 

CPP_DEPS += \
./source/utfpRTOS/so/IO.d \
./source/utfpRTOS/so/Memory.d 


# Each subdirectory must supply rules for building sources it contributes
source/utfpRTOS/so/%.o: ../source/utfpRTOS/so/%.cpp
	@echo 'Building file: $<'
